...
#            libnorm_type: Default to 1E6.
#            transformation: Defaul to "remove0", "libnorm", "log2p1", "qnorm" in order.
#            save_dir: Folder path.
#            save_each_step: Whether save each step, deafalt to TRUE.
# Output: None.
count_matrix_function <- function(bam_path, regions, libnorm_type = NULL, transformation = NULL, save_each_step = TRUE, save_dir) {
  # Create folder
  ...
  apply_transformations(binChriDataframe_full, libnorm_type, transformation, save_dir, datasetName_full)
}
